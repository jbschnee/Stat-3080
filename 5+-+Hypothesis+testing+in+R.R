...
#  one-sample t-test, the same assumptions are required: either the     #
#  differences of the paired values are normally distributed or there   #
#  are enough paired differences that the Central Limit Theorem holds.  #
#                                                                       #
